# Workflow Gate 手动检查清单

**使用场景：** 当 Python 脚本无法运行时的备用检查方案  
...
**使用前必读：**
- ✅ 本清单与 Python 脚本功能完全等价
- ✅ 按顺序检查，跳过任何步骤都可能导致 pipeline 破坏
...
3. **严格遵循**：这个清单与 Python 脚本功能完全等价，不能降低标准
4. **记录问题**：如果发现检查清单本身的问题，及时反馈改进

---

**最后更新：** 2026-04-17  
**对应的脚本版本：** agents/scripts/check_workflow_gate.py  
